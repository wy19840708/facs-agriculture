...
public  class UserServiceImpl implements IUserService {
	...
	@Override
	public UserResponse loadu(UserRequest paramDatau) {
		User object = userMapper.loadu(paramDatau.getId());
		return FacsBeanUtils.copy(object,UserResponse.class);
	}

	@Override
	public List<User> loadPageByUserid(Long Id) {
		List<User> list = userMapper.loadPageByUserid(Id);
		return list;
	}

	@Override
	public List<User> loadAll() {
		List<User> list = userMapper.loadAll();
