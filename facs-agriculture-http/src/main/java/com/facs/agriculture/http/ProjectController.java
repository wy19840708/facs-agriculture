...
public class ProjectController {
	...
	public @ResponseBody DataResult<MutiResponse<ProjectResponse>> page(@RequestBody PageRequest<ProjectQueryRequest> paramData) {
		MutiResponse<ProjectResponse> paging = projectService.loadPage(paramData);
		return DataResult.ok(paging);
	}

	@RequestMapping(value="/{id}")
	public @ResponseBody DataResult<ProjectResponse> load(ProjectRequest request) {
	...
	public @ResponseBody DataResult<SingleResponse<Long>> create(@RequestBody ProjectRequest request) {
		ProjectResponse object = projectService.create(request);
		return DataResult.ok(new SingleResponse<>(object.getId()));
	}

	@RequestMapping(value = "/modify")
	public @ResponseBody DataResult<SingleResponse<Long>> modify(@RequestBody ProjectRequest request) {
		ProjectResponse object = projectService.update(request);
		return DataResult.ok(new SingleResponse<>(object.getId()));
	}

	@RequestMapping(value = "/delete")
	public @ResponseBody DataResult<SingleResponse<Long>> delete(@RequestBody ProjectRequest request) {
